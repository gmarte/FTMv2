              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className='mt-2'>
                  <input
                    ...
                    className='w-full border border-gray-300 rounded-md outlin-none p-5'
                    >
                  </input>
                </div>
                <TaskTypeRadioGroup />                
                ...
                <div className='mt-4'>
                  ...
                  focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:bg-gray-100 disabled:text-gray-300 disabled:cursor-not-allowed'
                  >
                    Add Task
                  </button>
                </div>
